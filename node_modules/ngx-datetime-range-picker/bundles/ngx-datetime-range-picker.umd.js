(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/forms'), require('@angular/material/button'), require('@angular/material/form-field'), require('@angular/material/icon'), require('@angular/material/input'), require('@angular/material/select')) :
    typeof define === 'function' && define.amd ? define('ngx-datetime-range-picker', ['exports', '@angular/core', '@angular/common', '@angular/forms', '@angular/material/button', '@angular/material/form-field', '@angular/material/icon', '@angular/material/input', '@angular/material/select'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['ngx-datetime-range-picker'] = {}, global.ng.core, global.ng.common, global.ng.forms, global.ng.material.button, global.ng.material.formField, global.ng.material.icon, global.ng.material.input, global.ng.material.select));
}(this, (function (exports, i0, common, forms, button, formField, icon, input, select) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var NgxDatetimeRangePickerConstants = {
        DEFAULT: {
            OPTIONS: {
                dateArray: [],
    ...
    var getNotAvailableText = function () {
        return "N/A";
    };
    /**
     *
    ...
    var ɵ0 = tuple;
    var CalendarTypes = tuple("daily", "weekly", "monthly", "quarterly", "yearly");
    ...
    var DEFAULT_RANGES = NgxDatetimeRangePickerConstants.DEFAULT.RANGES;
    var MOMENT_CONVERSION_MAP = NgxDatetimeRangePickerConstants.CONSTANT.MOMENT_CONVERSION_MAP;
    var NgxDatetimeRangePickerService = /** @class */ (function () {
        ...
        NgxDatetimeRangePickerService.prototype.getDefaultState = function () {
            return cloneDeep(NgxDatetimeRangePickerConstants.DEFAULT.STATE);
        };
        NgxDatetimeRangePickerService.prototype.checkSettingsValidity = function (settings) {
            if (settings.type && !CalendarTypes.includes(settings.type)) {
                var errMsg = settings.type + " is an invalid calendar type. It should one of " + __spread(CalendarTypes);
        ...
        NgxDatetimeRangePickerService.prototype.createDefaultRanges = function (config) {
            ...
            var maxDate = cloneDeep(config.maxDate);
            DEFAULT_RANGES[type].forEach(function (rangeInfo) {
        ...
        NgxDatetimeRangePickerService.prototype.getSanitizedDateArray = function (config) {
            ...
            dateArray.forEach(function (date) {
                ...
                var value = format ? moment$1(date, format) : moment$1(date);
                if (value) {
                    var formattedDate = value.endOf(MOMENT_CONVERSION_MAP[type]).format(DEFAULT_DATE_FORMAT);
            ...
            return __spread(new Set(sanitizedDateArray));
        };
        NgxDatetimeRangePickerService.prototype.getNumberOfWeeks = function (date) {
            if (!date) {
                return;
            }
            var monthStart = moment$1(date, DEFAULT_DATE_FORMAT)
                .startOf("month")
                .day();
            var monthEnd = Number(moment$1(date, DEFAULT_DATE_FORMAT)
                .endOf("month")
                .format("D"));
            return Math.ceil((monthStart + monthEnd) / 7);
        };
        NgxDatetimeRangePickerService.prototype.getYearlyWeekCount = function (year) {
            if (!year) {
                return;
            }
            ...
            var yearEndDate = moment$1(year, "YYYY")
                .endOf("year")
                .format(DEFAULT_DATE_FORMAT);
            var yearEndWeekEndDate = moment$1(yearEndDate, DEFAULT_DATE_FORMAT)
                .startOf("week")
                .format(DEFAULT_DATE_FORMAT);
            var yearStartWeekEndDate = moment$1(yearStartDate, DEFAULT_DATE_FORMAT)
                .endOf("week")
                .format(DEFAULT_DATE_FORMAT);
            var yearStartWeekNumber = this.getWeekNumber(yearStartWeekEndDate);
        ...
        NgxDatetimeRangePickerService.prototype.getMonthsAvailable = function (minDate, maxDate, selectedYear) {
            ...
            var minDatems = moment$1(minDate, DEFAULT_DATE_FORMAT).valueOf();
            var maxDatems = moment$1(maxDate, DEFAULT_DATE_FORMAT).valueOf();
        ...
        NgxDatetimeRangePickerService.prototype.getYearsAvailable = function (config) {
            ...
            var years = [];
            if (minDate && maxDate) {
                var minYear = Number(this.getSelectedYear(minDate));
                var maxYear = Number(this.getSelectedYear(maxDate));
        ...
        NgxDatetimeRangePickerService.prototype.isDateToday = function (dateMs, config) {
            var todayDate = moment$1().format(DEFAULT_DATE_FORMAT);
            var type = config.type;
            var _a = this.getFirstLastDay(todayDate, type), firstDay = _a.firstDay, lastDay = _a.lastDay;
            var firstDayMs = moment$1(firstDay, DEFAULT_DATE_FORMAT).valueOf();
            var lastDayMs = moment$1(lastDay, DEFAULT_DATE_FORMAT).valueOf();
        ...
        NgxDatetimeRangePickerService.prototype.isInDateArray = function (date, dateArray, format) {
            if (!format) {
                format = null;
            }
            return dateArray.find(function (d) { return moment$1(d, format).valueOf() === date; }) !== undefined;
        };
        ...
        NgxDatetimeRangePickerService.prototype.getCalendarRowItemVariables = function (options) {
            var type = options.type, monthStartWeekNumber = options.monthStartWeekNumber, yearStartDate = options.yearStartDate, year = options.year, rowItem = options.rowItem, dateRows = options.dateRows, columns = options.columns;
            var itemCount = rowItem + dateRows * columns + dateRows;
            var currentItemDate = "";
            var rowItemText = "";
            if (type === "daily") {
                if (!isNil(monthStartWeekNumber) && !isNil(dateRows) && !isNil(year)) {
                    var yearStartDateDaily = moment$1()
                        .year(year)
                        .startOf("year")
                        .format(DEFAULT_DATE_FORMAT);
            ...
            var _a = this.getFirstLastDay(currentItemDate, type), firstDay = _a.firstDay, lastDay = _a.lastDay;
            return {
                itemCount: itemCount,
        ...
        NgxDatetimeRangePickerService.prototype.isRowIemValid = function (options) {
            ...
            var validWeekCount = this.getYearlyWeekCount(year);
            if (type === "daily") {
                valid = true;
            }
            else if (type === "weekly") {
        ...
        NgxDatetimeRangePickerService.prototype.getSelectedYear = function (date) {
        ...
        NgxDatetimeRangePickerService.prototype.getZoneDate = function (tz, format, date) {
            var _date = moment$1().valueOf();
            if (date) {
                _date = moment$1(date, format)
                    .startOf("day")
                    .valueOf();
            }
            var today = new Date(_date).toLocaleString("en-US", {
        ...
        NgxDatetimeRangePickerService.prototype.iterateOverDateObj = function (dates, func) {
            for (var side in dates) {
                if (side) {
                    var sideDates = dates[side];
                    sideDates.itemRows.forEach(function (rows) {
                        rows.items.forEach(function (rowItem) {
                            func(rowItem);
                        });
                    });
                }
        ...
        NgxDatetimeRangePickerService.prototype.getCalendarColspan = function (type) {
            if (type === "daily") {
                return 6;
            }
            else if (type === "weekly") {
        ...
        NgxDatetimeRangePickerService.prototype.getCalendarRowItemColspan = function (type) {
            if (type === "monthly") {
                return 3;
            }
            else if (type === "quarterly") {
        ...
        NgxDatetimeRangePickerService.prototype.getDateCharacteristics = function (config, state, date, month, side) {
            var currentDate = moment$1(date, DEFAULT_DATE_FORMAT)
                .startOf("day")
                .valueOf();
            var _date = this.formatDateToDefaultFormat(config.minDate, DEFAULT_DATE_FORMAT);
            var minDate = moment$1(_date, DEFAULT_DATE_FORMAT)
                .startOf("day")
                .valueOf();
            _date = this.formatDateToDefaultFormat(config.maxDate, DEFAULT_DATE_FORMAT);
            var maxDate = moment$1(_date, DEFAULT_DATE_FORMAT)
                .startOf("day")
                .valueOf();
            _date = this.formatDateToDefaultFormat(config.startDate, DEFAULT_DATE_FORMAT);
            var startDate = moment$1(_date, DEFAULT_DATE_FORMAT)
                .startOf("day")
                .valueOf();
            _date = this.formatDateToDefaultFormat(config.endDate, DEFAULT_DATE_FORMAT);
            var endDate = moment$1(_date, DEFAULT_DATE_FORMAT)
                .startOf("day")
                .valueOf();
            var currentMonthStartDate = moment$1(month, "MMM YYYY")
                .startOf("month")
                .startOf("day")
                .valueOf();
            var currentMonthEndDate = moment$1(month, "MMM YYYY")
                .endOf("month")
                .startOf("day")
                .valueOf();
            var available = this.isDateAvailable(currentDate, minDate, maxDate, startDate, endDate, currentMonthStartDate, currentMonthEndDate, config);
            var inRange = this.isDateInRange(currentDate, minDate, maxDate, startDate, endDate, currentMonthStartDate, currentMonthEndDate, available, config);
            var active = this.isDateActive(currentDate, startDate, endDate, side);
            var today = this.isDateToday(currentDate, config);
            // Active
            ...
            return { available: available, inRange: inRange, active: active, today: today };
        };
        NgxDatetimeRangePickerService.prototype.getLabelProps = function (state, calendarType, side) {
            ...
            return { label: label, labelFormat: labelFormat, type: type };
        };
    ...
    var DEFAULT_TIME_FORMAT$1 = NgxDatetimeRangePickerConstants.DEFAULT.TIME_FORMAT;
    var USA_TZ_CODE$1 = NgxDatetimeRangePickerConstants.CONSTANT.USA_TZ_CODE;
    var NgxDatetimeRangePickerComponent = /** @class */ (function () {
        function NgxDatetimeRangePickerComponent(element, renderer, service) {
            var _this = this;
            this.element = element;
            this.renderer = renderer;
            this.service = service;
            this.canBeEmpty = false;
            this.dateRangeModelChange = new i0.EventEmitter();
            this.dateRangeChanged = new i0.EventEmitter();
            this.inputFocusBlur = new i0.EventEmitter();
            this.selectedDate = new i0.EventEmitter();
        ...
        NgxDatetimeRangePickerComponent.prototype.ngOnChanges = function (changes) {
            var _this = this;
            var canBeEmpty = changes.canBeEmpty, settings = changes.settings, dateRangeModel = changes.dateRangeModel, optionService = changes.optionService, options = changes.options;
            if (canBeEmpty) {
            ...
            if (dateRangeModel && !dateRangeModel.firstChange) {
                var previousValue = dateRangeModel.previousValue[this.config.type];
                var currentValue = dateRangeModel.currentValue[this.config.type];
                if (previousValue &&
                    currentValue &&
            ...
            if (optionService && optionService.currentValue) {
                optionService.currentValue.subscribe(function (dateOptions) {
        ...
        // Events
        NgxDatetimeRangePickerComponent.prototype.onDateRangeInputChange = function (value) {
            this.dateRangeSelected();
        };
        NgxDatetimeRangePickerComponent.prototype.setDisabledState = function (disabled) {
            this.config.componentDisabled = disabled;
        };
        NgxDatetimeRangePickerComponent.prototype.onComponentClick = function () {
            this.state.isCalendarVisible = !this.state.isCalendarVisible;
        };
        NgxDatetimeRangePickerComponent.prototype.onFocusInput = function (event) {
            this.inputFocusBlur.emit({
                reason: InputFocusBlur.focus,
                value: event.target.value
            });
        };
        NgxDatetimeRangePickerComponent.prototype.onBlurInput = function (event) {
        ...
        NgxDatetimeRangePickerComponent.prototype.onCalendarClose = function (event) {
        ...
        NgxDatetimeRangePickerComponent.prototype.isPrevAvailable = function (side) {
            var _a = this.service.getLabelProps(this.state, this.config.type, side), label = _a.label, labelFormat = _a.labelFormat, type = _a.type;
            return (moment$2(label, labelFormat)
                .startOf(type)
                .valueOf() >
                moment$2(this.config.minDate, DEFAULT_DATE_FORMAT)
                    .startOf(type)
                    .valueOf());
        };
        NgxDatetimeRangePickerComponent.prototype.isNextAvailable = function (side) {
            var _a = this.service.getLabelProps(this.state, this.config.type, side), label = _a.label, labelFormat = _a.labelFormat, type = _a.type;
            return (moment$2(label, labelFormat)
                .endOf(type)
                .valueOf() <
                moment$2(this.config.maxDate, DEFAULT_DATE_FORMAT)
                    .endOf(type)
                    .valueOf());
        };
        NgxDatetimeRangePickerComponent.prototype.getCalendarColspan = function () {
            return this.service.getCalendarColspan(this.config.type);
        };
        NgxDatetimeRangePickerComponent.prototype.getCalendarRowItemColspan = function () {
            return this.service.getCalendarRowItemColspan(this.config.type);
        };
        NgxDatetimeRangePickerComponent.prototype.onClickPrevious = function (side) {
            var _a = this.service.getLabelProps(this.state, this.config.type, side), label = _a.label, labelFormat = _a.labelFormat, type = _a.type;
            var startDate = moment$2(label, labelFormat)
                .subtract(1, type)
                .startOf(type)
                .format(DEFAULT_DATE_FORMAT);
            this.state.dates[side] = this.generateCalendar(startDate, side);
        };
        NgxDatetimeRangePickerComponent.prototype.onClickNext = function (side) {
            var _a = this.service.getLabelProps(this.state, this.config.type, side), label = _a.label, labelFormat = _a.labelFormat, type = _a.type;
            var endDate = moment$2(label, labelFormat)
                .add(1, type)
                .endOf(type)
                .format(DEFAULT_DATE_FORMAT);
            this.state.dates[side] = this.generateCalendar(endDate, side);
        };
        NgxDatetimeRangePickerComponent.prototype.onCellClick = function (item, itemCell, side) {
            var date = moment$2(item.date, DEFAULT_DATE_FORMAT).valueOf();
            var startDate = moment$2(this.config.startDate, DEFAULT_DATE_FORMAT).valueOf();
            var endDate = moment$2(this.config.endDate, DEFAULT_DATE_FORMAT).valueOf();
            var minDate = moment$2(this.config.minDate, DEFAULT_DATE_FORMAT).valueOf();
            var maxDate = moment$2(this.config.maxDate, DEFAULT_DATE_FORMAT).valueOf();
            if (!item.available) {
                if (date < minDate || date > maxDate) {
                    return;
                }
        ...
        NgxDatetimeRangePickerComponent.prototype.onCellMouseEnter = function (item, itemCell) {
            var _this = this;
            if (!item.available) {
                return;
            }
            ...
            hoverItemFirstDate = moment$2(hoverItemFirstDate, DEFAULT_DATE_FORMAT).format(this.config.viewDateFormat);
            hoverItemLastDate = moment$2(hoverItemLastDate, DEFAULT_DATE_FORMAT).format(this.config.viewDateFormat);
            ...
            if (!endDate) {
                var func = function (rowItem) {
                    if (rowItem.available) {
                        var hoverItemDate = rowItem.date ? moment$2(rowItem.date, DEFAULT_DATE_FORMAT).valueOf() : rowItem.date;
                        if ((hoverItemDate > startDate && hoverItemDate < date) || date === hoverItemDate) {
                            rowItem.inRange = true;
                            _this.state.dateTitleText.right = activeItemInputFieldText;
                        }
                    }
                };
        ...
        NgxDatetimeRangePickerComponent.prototype.onCellMouseLeave = function () {
        ...
        NgxDatetimeRangePickerComponent.prototype.onRangeClick = function (rangeLabel, dateRangeModel) {
        ...
        NgxDatetimeRangePickerComponent.prototype.updateCalendar = function () {
        ...
        NgxDatetimeRangePickerComponent.prototype.onCalendarLabelChange = function (label, side, type) {
            ...
            if (this.config.type !== "yearly") {
                var selectedMonth = this.state.selectedMonth[side] + " " + this.state.selectedYear[side];
                ...
                if (this.state.selectedYear.left <= this.state.selectedYear.right && side === "right") {
                    this.config.startDate = moment$2(this.state.selectedYear.left, "YYYY")
                        .startOf("year")
                        .format(DEFAULT_DATE_FORMAT);
                    this.config.endDate = moment$2(this.state.selectedYear.right, "YYYY")
                        .endOf("year")
                        .format(DEFAULT_DATE_FORMAT);
                    this.doApply();
                }
                var config = {
                    startDate: moment$2(this.state.selectedYear.left, "YYYY")
                        .startOf("year")
                        .format(DEFAULT_DATE_FORMAT),
                    type: "yearly"
                };
                var startDate = this.service.formatStartDate(config, this.config.viewDateFormat);
                var endDate = this.config.endDate
                    ? moment$2(this.config.endDate, DEFAULT_DATE_FORMAT).format(this.config.viewDateFormat)
                    : "";
                this.state.dateTitleText.left = "" + startDate;
                this.state.dateTitleText.right = "" + endDate;
            }
        };
        NgxDatetimeRangePickerComponent.prototype.onTimeLabelChange = function (item, side, timeItem) {
            var time = null;
            if (side === "left") {
                ...
                var startDateEpoch = moment$2(this.config.startDate, DEFAULT_DATE_FORMAT).valueOf();
                var endDateEpoch = moment$2(this.config.endDate, DEFAULT_DATE_FORMAT).valueOf();
        ...
        NgxDatetimeRangePickerComponent.prototype.onTimeApply = function () {
            this.dateRangeSelected();
            this.updateInputField();
        };
        // Helpers
        NgxDatetimeRangePickerComponent.prototype.init = function () {
        ...
        NgxDatetimeRangePickerComponent.prototype.initialize = function () {
            this.state = this.service.getDefaultState();
        };
        NgxDatetimeRangePickerComponent.prototype.parseOptions = function () {
            var _this = this;
            if (this.options !== undefined) {
                Object.keys(this.options).forEach(function (k) {
                    if (!isNil(_this.options[k])) {
        ...
        NgxDatetimeRangePickerComponent.prototype.selectTimeZone = function () {
        ...
        NgxDatetimeRangePickerComponent.prototype.parseOptionsToDefaultDateFormat = function () {
         ...
         */
        NgxDatetimeRangePickerComponent.prototype.processDateRangeModel = function () {
            var _this = this;
            if (undefined === this.dateRangeModel || isEmpty(this.dateRangeModel)) {
                return;
            }
            if (!this.dateRangeModel[this.config.type]) {
                var _optionsKeys_1 = Object.keys(this.service.getDefaultOptions());
                var _model_1 = {};
                Object.keys(this.dateRangeModel).forEach(function (key) {
                    if (_optionsKeys_1.includes(key)) {
                        _model_1[key] = _this.dateRangeModel[key];
                        delete _this.dateRangeModel[key];
                    }
                });
                this.dateRangeModel[this.config.type] = _model_1;
                if (!this.dateRangeModel[this.config.type]) {
                    return;
                }
            }
            ...
            var dateRangeMinDate = this.dateRangeModel[this.config.type].minDate || this.config.minDate;
            var dateRangeMaxDate = this.dateRangeModel[this.config.type].maxDate || this.config.maxDate;
            var dateRangeStartDate = this.dateRangeModel[this.config.type].startDate || this.config.startDate;
            var dateRangeEndDate = this.dateRangeModel[this.config.type].endDate || this.config.endDate;
            ...
            if (this.config.timePicker) {
                var dateRangeMinTime = this.dateRangeModel[this.config.type].minTime || this.config.minTime;
                var dateRangeMaxTime = this.dateRangeModel[this.config.type].maxTime || this.config.maxTime;
                var dateRangeStartTime = this.dateRangeModel[this.config.type].startTime || this.config.startTime;
                var dateRangeEndTime = this.dateRangeModel[this.config.type].endTime || this.config.endTime;
         ...
         */
        NgxDatetimeRangePickerComponent.prototype.handleDateArray = function () {
            if (this.config.dateArray && this.config.dateArray.length) {
                ...
                // sort in asc order
                this.config.dateArray = this.config.dateArray.sort(function (date1, date2) {
                    var value1 = moment$2(date1, DEFAULT_DATE_FORMAT).valueOf();
                    var value2 = moment$2(date2, DEFAULT_DATE_FORMAT).valueOf();
                    return value1 - value2;
                });
            }
        };
        NgxDatetimeRangePickerComponent.prototype.sanitizeDates = function () {
            var _this = this;
            var subtractWeekCount = 0;
            var setDate = function (type) {
                _this.config.minDate = moment$2(_this.config.minDate, DEFAULT_DATE_FORMAT)
                    .endOf(type)
                    .format(DEFAULT_DATE_FORMAT);
                _this.config.maxDate =
                    type === "week"
                        ? moment$2(_this.config.maxDate, DEFAULT_DATE_FORMAT)
                        ...
                        : moment$2(_this.config.maxDate, DEFAULT_DATE_FORMAT)
                            .endOf(type)
                            .format(DEFAULT_DATE_FORMAT);
                _this.config.startDate = moment$2(_this.config.startDate, DEFAULT_DATE_FORMAT)
                    .endOf(type)
                    .format(DEFAULT_DATE_FORMAT);
                _this.config.endDate =
                    type === "week"
                        ? moment$2(_this.config.endDate, DEFAULT_DATE_FORMAT)
                            .subtract(subtractWeekCount, "week")
                            .endOf(type)
                            .format(DEFAULT_DATE_FORMAT)
                        : moment$2(_this.config.endDate, DEFAULT_DATE_FORMAT)
            ...
            if (moment$2(this.config.startDate, DEFAULT_DATE_FORMAT).valueOf() <
                moment$2(this.config.minDate, DEFAULT_DATE_FORMAT).valueOf()) {
                this.config.minDate = this.config.startDate;
            }
            if (moment$2(this.config.endDate, DEFAULT_DATE_FORMAT).valueOf() >
                moment$2(this.config.maxDate, DEFAULT_DATE_FORMAT).valueOf()) {
                this.config.maxDate = this.config.endDate;
            }
        };
        NgxDatetimeRangePickerComponent.prototype.processRanges = function () {
        ...
        NgxDatetimeRangePickerComponent.prototype.selectActiveRange = function () {
            for (var range in this.config.availableRanges) {
                if (range) {
                    var rangeModel = this.config.availableRanges[range];
        ...
        NgxDatetimeRangePickerComponent.prototype.generateCalendar = function (date, side) {
            var _this = this;
            this.state.selectedMonth[side] = moment$2(date, DEFAULT_DATE_FORMAT).format("MMM");
            this.state.selectedYear[side] = this.service.getSelectedYear(date);
            var calendarLabel = this.state.selectedMonth[side] + " " + this.state.selectedYear[side];
            var dates = {
                label: calendarLabel,
            ...
            if (this.config.type !== "yearly") {
                ...
                var monthStartWeekNumber = moment$2(date, DEFAULT_DATE_FORMAT)
                    .year(this.state.selectedYear[side])
                    .startOf("month")
                    .week(); // previousMonthLastWeek
                var yearStartDate = moment$2(this.state.selectedYear[side], "YYYY")
                    .startOf("year")
                    .format(DEFAULT_DATE_FORMAT);
                var numberOfRows = 1;
                if (this.config.type === "daily") {
                ...
                for (var dateRows = 0; dateRows < numberOfRows; dateRows++) {
                    ...
                    var _a = this.service.getCalendarRowVariables(rowOptions), rowNumber = _a.rowNumber, columns = _a.columns;
                    ...
                    for (var rowItem = 0; rowItem <= columns; rowItem++) {
                        ...
                        var _b = this.service.getCalendarRowItemVariables(rowItemOptions), currentItemDate = _b.currentItemDate, rowItemText = _b.rowItemText, firstDay = _b.firstDay, lastDay = _b.lastDay, itemCount = _b.itemCount;
                        rowOptions.itemCount = itemCount;
                        var _c = this.service.getDateCharacteristics(this.config, this.state, currentItemDate, calendarLabel, side), available = _c.available, inRange = _c.inRange, active = _c.active, today = _c.today;
                        var itemObj = {
            ...
            setTimeout(function () {
                var options = {
                    side: side,
                    onChange: _this.onCalendarLabelChange.bind(_this),
                    type: "month",
                    items: dates["months"],
                    selected: _this.state.selectedMonth[side]
                };
                _this.printSelect(options);
                options.type = "year";
                options.items = dates["years"];
                options.selected = _this.state.selectedYear[side];
                _this.printSelect(options);
            });
            return dates;
        };
        NgxDatetimeRangePickerComponent.prototype.generateTimePicker = function (time, side) {
            var _this = this;
            var timeObject = {
                hour: [],
                minute: [],
            ...
            for (var h = startHour; h <= 23; h++) {
                var stringified_h = this.service.convertToViewTimeItem(h);
                timeObject.hour.push(stringified_h);
            }
            for (var m = startMinute; m <= 59; m++) {
                var stringified_m = this.service.convertToViewTimeItem(m);
            ...
            setTimeout(function () {
                var options = {
                    side: side,
                    onChange: _this.onTimeLabelChange.bind(_this),
                    type: "hour",
                    items: timeObject["hour"],
                    selected: _this.state.selectedHour[side]
                };
                _this.printSelect(options);
                options.type = "minute";
                options.items = timeObject["minute"];
                options.selected = _this.state.selectedMinute[side];
                _this.printSelect(options);
            });
            return timeObject;
        };
        NgxDatetimeRangePickerComponent.prototype.updateInputField = function () {
            var startDate = this.service.formatStartDate(this.config, this.config.viewDateFormat);
            var endDate = this.config.endDate
                ? moment$2(this.config.endDate, DEFAULT_DATE_FORMAT).format(this.config.viewDateFormat)
                : "";
            if (this.config.singleDatePicker) {
        ...
        NgxDatetimeRangePickerComponent.prototype.updateActiveItemInputField = function () {
            if (!this.config.singleDatePicker) {
                this.updateSide("left");
            }
            this.updateSide("right");
        };
        NgxDatetimeRangePickerComponent.prototype.updateSide = function (side) {
            var itemFirstDate = this.state.activeItem[side].firstDay;
            var itemLastDate = this.state.activeItem[side].lastDay;
            var itemText = this.state.activeItem[side].rowItemText;
            itemFirstDate = moment$2(itemFirstDate, DEFAULT_DATE_FORMAT).format(this.config.viewDateFormat);
            itemLastDate = moment$2(itemLastDate, DEFAULT_DATE_FORMAT).format(this.config.viewDateFormat);
            if (this.config.type !== "daily") {
        ...
        NgxDatetimeRangePickerComponent.prototype.dateRangeSelected = function () {
            var dateRangeModel = this.getNgxDatetimeRangeChangeOutput();
            this.state.isCalendarVisible = false;
            this.filterInputBox.nativeElement.classList.remove("empty-filter");
            this.doDateRangeModelChange();
            this.dateRangeChanged.emit(dateRangeModel);
        };
        NgxDatetimeRangePickerComponent.prototype.doDateRangeModelChange = function () {
            var dateRangeModel = this.getDateRangeModel(this.config.inputDateFormat);
            this.dateRangeModelChange.emit(dateRangeModel);
        };
        NgxDatetimeRangePickerComponent.prototype.getDateRangeModel = function (format) {
            var dRModel = {};
            if (undefined !== this.dateRangeModel && !isEmpty(this.dateRangeModel)) {
        ...
        NgxDatetimeRangePickerComponent.prototype.getNgxDatetimeRangeChangeOutput = function (format) {
            var dateRangeChangeOutput;
            var outputDateFormat = this.config.outputDateFormat;
            if (undefined !== format) {
                outputDateFormat = format;
            }
            var startDate = this.service.formatStartDate(this.config, outputDateFormat);
            var endDate = moment$2(this.config.endDate, DEFAULT_DATE_FORMAT).format(outputDateFormat);
        ...
        NgxDatetimeRangePickerComponent.prototype.doApply = function () {
            var _this = this;
            var startDate = this.config.startDate;
            var endDate = this.config.endDate;
            this.state.activeStartDate = startDate;
            this.state.activeEndDate = endDate;
            if (this.config.startDate && this.config.endDate) {
                if (!this.config.timePicker) {
                    this.dateRangeSelected();
                }
                    ...
                    if (this.config.timePicker) {
                        this.state.sides.forEach(function (side) {
                            _this.state.times[side] = _this.generateTimePicker(null, side);
                        });
                    }
                }
            }
            var outputStartDate = startDate ? moment$2(startDate, DEFAULT_DATE_FORMAT).valueOf() : null;
            var outputEndDate = endDate ? moment$2(endDate, DEFAULT_DATE_FORMAT).valueOf() : null;
            if (this.config.outputDateFormat) {
                outputStartDate = startDate ? moment$2(startDate, DEFAULT_DATE_FORMAT).format(this.config.outputDateFormat) : null;
                outputEndDate = endDate ? moment$2(endDate, DEFAULT_DATE_FORMAT).format(this.config.outputDateFormat) : null;
            }
        ...
        NgxDatetimeRangePickerComponent.prototype.onTimezoneChange = function (tz) {
            var _this = this;
            ...
            this.state.sides.forEach(function (side) {
                ...
                _this.state.dates[side] = _this.generateCalendar(date, side);
                if (_this.config.timePicker) {
                    _this.state.times[side] = _this.generateTimePicker(time, side);
                }
            });
        };
        NgxDatetimeRangePickerComponent.prototype.getSelectedTimeItemText = function (item, side) {
            if (item === "hour") {
        ...
        NgxDatetimeRangePickerComponent.prototype.setActiveItemOnRangeClick = function () {
            this.updateActiveItem();
            this.doApply();
        };
        NgxDatetimeRangePickerComponent.prototype.updateActiveItem = function () {
            var startDate = this.service.getFirstLastDay(this.config.startDate, this.config.type);
            var endDate = this.service.getFirstLastDay(this.config.endDate, this.config.type);
            if (this.config.type === "weekly") {
                ...
                startDate.rowItemText = "" + moment$2(startDate.firstDay, DEFAULT_DATE_FORMAT).format("MMM");
                endDate.rowItemText = "" + moment$2(endDate.firstDay, DEFAULT_DATE_FORMAT).format("MMM");
            }
            else if (this.config.type === "quarterly") {
                startDate.rowItemText = "Quarter " + moment$2(startDate.firstDay, DEFAULT_DATE_FORMAT).quarter();
                endDate.rowItemText = "Quarter " + moment$2(endDate.firstDay, DEFAULT_DATE_FORMAT).quarter();
            }
        ...
        /* ------------------------------------------ */
        NgxDatetimeRangePickerComponent.prototype.printSelect = function (options) {
            var optionHTML = "";
    ...
    ObjNgFor.decorators = [
        { type: i0.Pipe, args: [{ name: "ObjNgFor", pure: false },] }
    ];
    ...
    NgxDatetimeRangePickerModule.decorators = [
        { type: i0.NgModule, args: [{
                    ...
                    imports: [common.CommonModule, forms.FormsModule, MaterialModule],
                    exports: [NgxDatetimeRangePickerComponent, MaterialModule]
                },] }
    ];
    NgxDatetimeRangePickerModule.ctorParameters = function () { return [
        { type: NgxDatetimeRangePickerModule, decorators: [{ type: i0.Optional }, { type: i0.SkipSelf }] }
    ]; };
    ...
    exports.CalendarTypes = CalendarTypes;
    exports.NgxDatetimeRangePickerComponent = NgxDatetimeRangePickerComponent;
    exports.NgxDatetimeRangePickerModule = NgxDatetimeRangePickerModule;
    exports.NgxDatetimeRangePickerService = NgxDatetimeRangePickerService;
    exports.ɵ0 = ɵ0;
    exports.ɵa = ObjNgFor;
